...
def set_value(
    motor: int, power: Union[None, bool] = None, direction: Union[None, bool] = None
):
    """Sets a motors state"""
...
def on(motor: int):
    """Turns a motor on"""
    print(f"Turning motor {motor} on, gpio pin {PWR_PINS[motor]}")
...
class Motor:
    ...
    def set_val(
        self, power: Union[None, bool] = None, direction: Union[None, bool] = None
    ):
        if not direction is None:
